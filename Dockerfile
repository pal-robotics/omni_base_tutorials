...
ARG REPO_WS=/tiago_base_public_ws
...
RUN apt-get update && apt-get install -y --no-install-recommends \
  ...
  && wget https://raw.githubusercontent.com/pal-robotics/omni_base_tutorials/master/tiago_base_public-melodic.rosinstall \
  && vcs import src < tiago_base_public-melodic.rosinstall
